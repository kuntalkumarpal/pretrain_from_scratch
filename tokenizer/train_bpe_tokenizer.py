...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_path', type=str, default="/scratch/kkpal/NEW_VAREC/tokenizer/source", help='path to the input text files')
    parser.add_argument('--vocab_size', type=int, default=50265, help='size of tokenizer vocabulary')
    parser.add_argument('--min_frequency', type=int, default=2, help='minium frequency')
    parser.add_argument('--output_path', type=str, default="/scratch/kkpal/NEW_VAREC/tokenizer/bpe", help='path to the output text files')
